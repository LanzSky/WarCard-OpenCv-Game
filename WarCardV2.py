...
human_card_value = 0
bot_card_value = 0
card_text_h = "tidak ada kartu"
card_text_b = "tidak ada kartu"
hasil = ""
...
def get_human_card_choice(human_card, detected_card):
    if detected_card in human_card:
        return detected_card
    else:
        print("Kartu tidak ditemukan dalam daftar. Silakan coba kartu lain.")
        return None

def detect_card_from_camera(image, train_ranks, train_suits):
...
while cam_quit == 0:
    ...
    if Game == 1:
        ...
        if human_card or bot_card:
            detected_card = detect_card_from_camera(image, train_ranks, train_suits)
            selected_human_card = get_human_card_choice(human_card, detected_card)
            if detected_card :
                ...
                card_text_h = "kartu tidak terdeteksi"
        else:
            card_text_h = "Tidak ada kartu tersisa, permainan selesai. tekan 1 untuk memulai lagi"
            card_text_b = "Tidak ada kartu tersisa, permainan selesai. tekan 1 untuk memulai lagi"

    elif Game == 4:
        human_card_value == bot_card_value
        card_text_h = "Jumlah value player :", total_human_value
        card_text_b = "Jumlah value Bot :", total_bot_value
